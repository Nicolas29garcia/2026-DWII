...
| `01_php-intro/includes/nav.php` | Menu de navegação |
| `01_php-intro/includes/rodape.php` | Rodapé do site |
| `02_formularios/` | Atividade de formulários em PHP |
| `02_formularios/index.php` | Página inicial da pasta de formulários |
| `02_formularios/contato.php` | Página com formulário de contato |
| `02_formularios/obrigado.php` | Página que exibe os dados enviados |
...
### 👤 Sobre
Apresenta informações sobre o estudante, formação e interesses.

### 💻 Projetos
Lista projetos e atividades desenvolvidas durante o curso.

### 📬 Contato
Formulário que permite enviar uma mensagem, exibindo os dados enviados na página de confirmação.
